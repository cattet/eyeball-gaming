...
export const BASE_PLAYER_DATA: Player[] = [
    { id: 0, job: 'MCH', subRole: SUBROLE['prange'], level: 90, name: 'Range One', group: 1, maxHealth: 66791, healthPercent: 1, shieldPercent: .7, manaPercent: 1, aggroPercent: 0.2, aggroOrder: 6, jobPriority: 2, groupPriority: 2, lineUpOrder: 0, statuses: [] },
    { id: 1, job: 'WAR', subRole: SUBROLE['tank'], level: 90, name: 'Tank One', group: 1, maxHealth: 94171, healthPercent: 0.8, shieldPercent: .3, manaPercent: 1, aggroPercent: 0.8, aggroOrder: 2, jobPriority: 4, groupPriority: 2, lineUpOrder: 0, statuses: [] },
    { id: 2, job: 'PLD', subRole: SUBROLE['tank'], level: 90, name: 'Tank Two', group: 2, maxHealth: 96236, healthPercent: 0.65, shieldPercent: .3, manaPercent: 1, aggroPercent: 1, aggroOrder: 1, jobPriority: 4, groupPriority: 1, lineUpOrder: 0, statuses: [] },
    { id: 3, job: 'WHM', subRole: SUBROLE['healer'], level: 90, name: 'Healer One', group: 1, maxHealth: 61056, healthPercent: 1, shieldPercent: .6, manaPercent: .777, aggroPercent: 0.1, aggroOrder: 7, jobPriority: 3, groupPriority: 2, lineUpOrder: 0, statuses: [] },
    { id: 4, job: 'SCH', subRole: SUBROLE['healer'], level: 90, name: 'Healer Two', group: 2, maxHealth: 61056, healthPercent: 1, shieldPercent: .95, manaPercent: .95, aggroPercent: 0.1, aggroOrder: 8, jobPriority: 3, groupPriority: 1, lineUpOrder: 0, statuses: [] },
    { id: 5, job: 'DRG', subRole: SUBROLE['melee'], level: 90, name: 'Melee One', group: 1, maxHealth: 67602, healthPercent: 1, shieldPercent: .6, manaPercent: 1, aggroPercent: 0.3, aggroOrder: 4, jobPriority: 1, groupPriority: 2, lineUpOrder: 0, statuses: [] },
    { id: 6, job: 'SMN', subRole: SUBROLE['melee'], level: 90, name: 'Melee Two', group: 2, maxHealth: 58116, healthPercent: 1, shieldPercent: .8, manaPercent: .96, aggroPercent: 0.2, aggroOrder: 5, jobPriority: 1, groupPriority: 1, lineUpOrder: 0, statuses: [] },
    { id: 7, job: 'PCT', subRole: SUBROLE['caster'], level: 90, name: 'Range Two', group: 2, maxHealth: 61081, healthPercent: 1, shieldPercent: .75, manaPercent: .95, aggroPercent: 0.4, aggroOrder: 3, jobPriority: 2, groupPriority: 1, lineUpOrder: 0, statuses: [] }
]
